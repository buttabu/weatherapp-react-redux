		...
		return (
			<div>
				...
				<ul class="list-group">
					...
					<strong>Relative Humidity: </strong>{this.props.weather.current_observation.relative_humidity}
					</li>

					<li class="list-group-item">
					<strong>Wind: </strong>{this.props.weather.current_observation.wind_string}
					</li>

					<li class="list-group-item">
					<strong>Relative Dewpoint: </strong>{this.props.weather.current_observation.dewpoint_string}
					</li>
				</ul>
			</div>
			)
